...
l1_edges = set()
l1_rels = []
with open(f'{base}/data/relationships.csv', encoding='utf-8') as f:
...
core_ids = set()
names = {}
with open(f'{base}/data/persons.csv', encoding='utf-8') as f:
    for r in csv.DictReader(f):
...
# Load Layer 2 raw
l2_rels = []
with open(f'{base}/data/relationships_layer2.csv', encoding='utf-8') as f:
    for r in csv.DictReader(f):
        l2_rels.append(r)
